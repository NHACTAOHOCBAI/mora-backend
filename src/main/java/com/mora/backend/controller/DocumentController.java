...
public class DocumentController {
    ...
    public ResponseEntity<ApiResponse<DocumentDetailResponse>> getDocumentById(@PathVariable("id") Long id) {
    ...
    public ResponseEntity<ApiResponse<DocumentDetailResponse>> generateStudyNotes(@PathVariable("id") Long id) {
        DocumentDetailResponse response = documentService.generateStudyNotes(id);
        return ResponseEntity.ok(
                ApiResponse.<DocumentDetailResponse>builder()
                        .message("Tạo tóm tắt và câu hỏi ôn tập thành công")
                        .result(response)
                        .build()
        );
    }
    ...
    public ResponseEntity<ApiResponse<java.util.List<com.mora.backend.model.dto.response.DocumentImageDebugResponse>>> debugDocumentImages(@PathVariable("id") Long id) {
        ...
        return ResponseEntity.ok(
                ApiResponse.<java.util.List<com.mora.backend.model.dto.response.DocumentImageDebugResponse>>builder()
                        .message("Lấy danh sách ảnh debug thành công")
                        .result(response)
                        .build()
        );
    }
